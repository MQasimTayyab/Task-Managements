  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      ...
      reviews: List<Reviews>.from(
        json['reviews'].map((e) => Reviews.fromJson(e)),
      ),
...
List<Product> productShows =
    productShow.map((productShow) => Product.fromJson(productShow)).toList();

List<Map<String, dynamic>> productShow = [
  {
    "id": 1,
  ...
  },
  {
    ...
    "images": [
      "https://cdn.dummyjson.com/product-images/beauty/powppder-canister/1.webp"
    ],
    "thumbnail":
